...
const resources = {
    en: {
        translation: {
            ...
            "description1": "Joshua's Legs is a strange game with devious controls about a two-legged arachnid hoping to find his long lost prosthetic legs collection. Venture in a world that will only reveal its secrets to the true hardened climbers.",
            "description2": "Learn the mystic art of spider acrobatics in this strange game in which you control a two-legged arachnid with your joysticks. Release your inner monk to achieve absolute finesse, precision, speed and consistency in order to find all of Joshua's prostheses.",
    ...
    fr: {
        translation: {
            ...
            "descriptionTitle": "Description",
            "description1": "Joshua's Legs est un jeu étrange avec des contrôles sournois à propos d'un arachnide à deux pattes qui espère retrouver sa collection de pattes prosthétiques depuis longtemps perdues. Aventurez-vous dans un monde qui révèlera ses secrets seulement aux vrais grimpeurs endurcis.",
            "description2": "Apprenez les arts mystiques des acrobaties d’araignées dans ce jeu étrange où vous contrôlez un arachnide à deux pattes avec vos joysticks. Libérez votre moine intérieur pour atteindre la finesse, la précision, la vitesse et la constance absolue pour trouver toutes les prothèses de Joshua.",
